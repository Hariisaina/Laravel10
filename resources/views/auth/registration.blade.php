        ...
        <div class="col-md col-md-offset-4" style="margin-top:20px">
            ...
            <form action="{{Route('register-user')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Entrer le nom complet" name="name" value="{{ old('name') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" placeholder="Entrez le mot de passe" name="password" value="{{ old('password') }}">
